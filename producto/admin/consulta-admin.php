...
<?php require_once("header-admin.php");?>
    ...
    <div class="contenedor col-sm-12 col-md-12 col-lg-12">
        <div class="col-sm-12 col-md-12 col-lg-6 caja_izquierda">
                <div>
                    <a class="btn btn-success" href="agregar-admin.php"> Agregar Producto </a>
                </div>
                <table class="table border">
                        ...
                        foreach ($result as $producto){ 
                            ...
                            <tr>
                                ...
                                <td scope="col border">
                                    <a class="btn btn-success" href="modificar-admin.php?id=<?=$producto["id_prod"]; ?>"> Modificar </a>
                                </td>
                                <td scope="col border">
                                <a class="btn btn-danger" href="eliminar-admin.php?id=<?=$producto["id_prod"]; ?>"> Eliminar</a></td>
                            </tr>
                        <?php } ?>
                </table>         
        </div>
